...
<<<<<<< HEAD
		this.logWrite("Chargement des plugins par d√©faut...");
		this.screen.setLabel("Chargement des plugins par d√©faut...");
=======
		this.logWrite("Chargement des plugins par dÈfaut...");
		this.screen.setLabel("Chargement des plugins par dÈfaut...");
...
<<<<<<< HEAD
		this.screen.setLabel("Plateforme charg√©e");
		this.logWrite("Coeur charg√©");
=======
		this.screen.setLabel("Plateforme chargÈe");
		this.logWrite("Coeur chargÈ");
>>>>>>> Update some PluginManager bugs
	...
	/**
	 * Retourne l'URL du chemin vers une librairie donn√©e
	...
	private URL getLibraryURL(String librarieName)
	{
		...
		{
<<<<<<< HEAD
			this.logError("Le chemin d√©fini vers \""+librarieName+"\" est incorrect"+
=======
			this.logError("Le chemin dÈfini vers \""+librarieName+"\" est incorrect"+
>>>>>>> Update some PluginManager bugs
					"\n"+mURLe.getMessage());
			return null;
		}
	...
	public Object loadPlugin(IPluginDescriptor descriptor, boolean active)
	{
		...
		{
			/*
			 * Pour toutes les interfaces dont d√©pend le plugin
			 */
			for(String intfce:descriptor.getInterfaces())
			{
				/*
				 * On recherche le plugin qui poss√®de cette interface
				 */
				for(IPluginDescriptor plugin:this.plugins)
				{
					...
					{
						/*
						 * Pour chaque interface que poss√®de le plugin
						 */
						for(String depd:plugin.getDependencies())
						{
							/*
							 * Si l'interface est celle d√©sir√©e, on ajoute son path dans le classloader
							 */
...
>>>>>>> Update some PluginManager bugs
		...
		try
		{
			...
			if(descriptor.getLibraries()!=null&&descriptor.getLibraries().size()>0)
			{
				 ...
				 * (Ces libraries doivent √™tre plac√©es dans le dossier "libs" du
				 * path du coeur)
				 */
		...
		{
<<<<<<< HEAD
			this.logError("Le chemin d√©fini vers \""+descriptor.getName()+"\" est incorrect"+
=======
			this.logError("Le chemin dÈfini vers \""+descriptor.getName()+"\" est incorrect"+
>>>>>>> Update some PluginManager bugs
						"\n"+mURLe.getMessage());
			return null;
		}
...
<<<<<<< HEAD
						descriptor.getName()+"\" n'a pas √©t√© trouv√©e");
=======
						descriptor.getName()+"\" n'a pas ÈtÈ trouvÈe");
>>>>>>> Update some PluginManager bugs
			return null;
		}
		...
		{
<<<<<<< HEAD
			this.logError("Ce plugin n'est pas valide: La classe n'impl√©mente" +
=======
			this.logError("Ce plugin n'est pas valide: La classe n'implÈmente" +
>>>>>>> Update some PluginManager bugs
...
<<<<<<< HEAD
							descriptor.getName()+"\" n'a pas pu √™tre trouv√©");
=======
							descriptor.getName()+"\" n'a pas pu Ítre trouvÈ");
>>>>>>> Update some PluginManager bugs
			...
			catch (SecurityException se)
			{
				this.logError("Le constructeur du plugin \""+
<<<<<<< HEAD
						descriptor.getName()+"\" n'a pas pu √™tre invoqu√©"+
=======
						descriptor.getName()+"\" n'a pas pu Ítre invoquÈ"+
>>>>>>> Update some PluginManager bugs
						"\n"+se.getMessage());
				if(descriptor.isActive()==active)
				{
	    ...
	    try
		{
			...
			{
<<<<<<< HEAD
				this.logWrite("Le plugin \""+descriptor.getName()+"\" a √©t√© charg√©");
=======
				this.logWrite("Le plugin \""+descriptor.getName()+"\" a ÈtÈ chargÈ");
>>>>>>> Update some PluginManager bugs
			...
			{
<<<<<<< HEAD
				this.logError("Le plugin \""+descriptor.getName()+"\" n'a pas pu √™tre charg√©");
=======
				this.logError("Le plugin \""+descriptor.getName()+"\" n'a pas pu Ítre chargÈ");
>>>>>>> Update some PluginManager bugs
				return null;
			}
		}
	...
	synchronized public boolean loadConfigs()
	{
		...
		{
<<<<<<< HEAD
			this.logError("Aucun fichier de configuration d√©finit");
=======
			this.logError("Aucun fichier de configuration dÈfinit");
>>>>>>> Update some PluginManager bugs
			return false;
		}
		...
		int i=1;
<<<<<<< HEAD
		this.logWrite(nbPlugins+" plugins pr√©sents dans:\n\""+path+"\"");
=======
		this.logWrite(nbPlugins+" plugins prÈsents dans:\n\""+path+"\"");
>>>>>>> Update some PluginManager bugs
...
<<<<<<< HEAD
		this.logWrite("Configurations charg√©es");
=======
		this.logWrite("Configurations chargÈes");
>>>>>>> Update some PluginManager bugs
		return true;
	}
...
>>>>>>> Update some PluginManager bugs
	...
	/**
	 * D√©finit le fichier de configuration de la plateforme
